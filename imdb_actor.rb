...
class ImdbActor < Imdb
    ...
    def actor_lowest_rated_movie
        ...
        lowest_rated_movie_a = movies_score.select { |_k, v| v > 0 }.sort_by { |_movie, score| score }.first
        lowest_rated_movie = {}
    ...
    def actor_highest_rated_movie
        ...
        highest_rated_movie_a = movies_score.select { |_k, v| v > 0 }.sort_by { |_movie, score| score }.last
        highest_rated_movie = {}
